---
doc_id: langchain-langsmith-trace-with-langgraph
title: Trace With Langgraph
source_type: public
vendor: langchain
doc_type: vendor_documentation
category: observability
source_path: public/langchain/langsmith/trace-with-langgraph.mdx
original_path: langsmith/trace-with-langgraph.mdx
url: https://github.com/langchain-ai/docs/blob/main/src/langsmith/trace-with-langgraph.mdx
