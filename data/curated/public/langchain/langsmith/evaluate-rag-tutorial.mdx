---
  doc_id: "langchain-langsmith-evaluate-rag-tutorial"
  title: "Evaluate Rag Tutorial"
  source_type: "public"
  vendor: "langchain"
  doc_type: "vendor_documentation"
  category: "evaluation"
  source_path: "public/langchain/langsmith/evaluate-rag-tutorial.mdx"
  original_path: "langsmith/evaluate-rag-tutorial.mdx"
  url: "https://github.com/langchain-ai/docs/blob/main/src/langsmith/evaluate-rag-tutorial.mdx"
