---
  doc_id: "langchain-langsmith-prompt-engineering-concepts"
  title: "Prompt Engineering Concepts"
  source_type: "public"
  vendor: "langchain"
  doc_type: "vendor_documentation"
  category: "prompt-engineering"
  source_path: "public/langchain/langsmith/prompt-engineering-concepts.mdx"
  original_path: "langsmith/prompt-engineering-concepts.mdx"
  url: "https://github.com/langchain-ai/docs/blob/main/src/langsmith/prompt-engineering-concepts.mdx"
