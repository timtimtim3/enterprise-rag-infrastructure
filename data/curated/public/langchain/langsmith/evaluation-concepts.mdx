---
doc_id: langchain-langsmith-evaluation-concepts
title: Evaluation Concepts
source_type: public
vendor: langchain
doc_type: vendor_documentation
category: evaluation
source_path: public/langchain/langsmith/evaluation-concepts.mdx
original_path: langsmith/evaluation-concepts.mdx
url: https://github.com/langchain-ai/docs/blob/main/src/langsmith/evaluation-concepts.mdx
